...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch (keycode) {
        case WINLOCK: // when pressed toggles between winlock on/off. LED turns on/off also (at scroll lock)
            if (record->event.pressed) {
                // when keycode WINLOCKON is pressed
                process_magic(QK_MAGIC_TOGGLE_GUI, record);
    ...
    [_LAYER0] = LAYOUT_tkl_f13_ansi_tsangan(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_MUTE,    KC_PSCR, WINLOCK, KC_MPLY,
    ...
    [_LAYER1] = LAYOUT_tkl_f13_ansi_tsangan(
        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,      BL_TOGG, KC_SCRL, RGB_TOG,
